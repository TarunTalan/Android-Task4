...
import com.example.myapp.databinding.ActivityVideosBinding
...
class VideosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.videos)) { v, insets ->
        ...
        val adapter = MyVideosAdapter(videoList)
